...
//           result = (int) getContext().getResources().getDimension(R.dimen.dp_35);
     ...
     * 绘制打勾动画
     */
    public void loginSuccess(final SmartLoadingView.AnimationOKListener animationOKListener) {
    ...
    public void setFollowClickListener(final SmartLoadingView.FollowClickListener followClickListener) {
    ...
    public void setLoginClickListener(final SmartLoadingView.LoginClickListener loginClickListener) {
        this.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
