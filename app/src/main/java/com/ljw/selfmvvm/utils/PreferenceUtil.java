...
public final class PreferenceUtil {
    ...
    public static final String FILE_NAME = "ljw_sp";
    ...
    public static void put(String key, Object object) {
        ...
        SharedPreferences sp = ContextUtils.getApp().getSharedPreferences(FILE_NAME,
                ContextUtils.getApp().MODE_PRIVATE);
    ...
    public static <T extends Serializable> boolean putByClass(String key, T entity) {
        ...
        SharedPreferences sp = ContextUtils.getApp().getSharedPreferences(prefFileName, 0);
