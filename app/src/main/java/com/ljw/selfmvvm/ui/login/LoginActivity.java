...
import com.ljw.selfmvvm.common.Params;
import com.ljw.selfmvvm.databinding.ActivityLoginBinding;
import com.ljw.selfmvvm.utils.ActivityUtils;
import com.ljw.selfmvvm.utils.KeyBoardUtils;
...
/**
 * Create by Ljw on 2019/12/16 16:11
 */
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 12:
                    ...
                    mViewModel.login(Params.login(text_phone, text_password), ParamsBuilder.builder().isShowDialog(false))
                            .observe(LoginActivity.this, resource -> {
                                resource.handler(new OnCallBack<UserBean>() {
                                    @Override
